...
"""
try:
 conn = mysql.connector.connect(host=configKhs.host, user=configKhs.user, password=configKhs.passwd, database=configKhs.database)
 cursor = conn.cursor()
...
CREATE TABLE IF NOT EXISTS artefacts (
    id_artefact varchar(255) NOT NULL,
 ...
 CREATE TABLE IF NOT EXISTS liens(
     ...
     secondaire varchar(255) NOT NULL,
